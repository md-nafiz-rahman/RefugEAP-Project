...
<section class="sec1">
    ...
    <p>Join the RefugEAP Network by subscribing to our <a href="https://www.jiscmail.ac.uk/cgi-bin/webadmin?SUBED1=REFUGEAP-NETWORK&A=1" style="text-decoration: underline;">JISC mail discussion list</a>. This functions as a mutual support network for individuals and organisations involved and/or interested in developing widening participation initiatives for refugee-background students to facilitate access to HE via English language pathways, with a particular focus on English for Academic Purposes. It will also be a place where you can keep up to date with what’s happening in the Working Group and on the RefugEAP Programme (which will sometimes put out a call for more volunteer tutors via this JISCmail list).</p>
</section>

<section class="sec1">
    <h3>Other ways:</h3>
    <ul>
        <li>Other similar networks which are not EAP-specific but which are very useful for those working in EAP/HE contexts are the <a href="https://www.jiscmail.ac.uk/universities-of-sanctuary" style="text-decoration: underline;">Universities of Sanctuary JISCmail discussion list</a>, and the <a href="https://hub.refugeelearningstories.org/" style="text-decoration: underline;">Hub for European Refugee Education mailing list</a></li>
        <li>You could contribute to our <a href="https://padlet.com/refugeapnetwork/ResourceBank" style="text-decoration: underline;">RefugEAP Network Resource Bank Padlet</a>. In particular, we are looking for people to share any relevant sanctuary-related job/role descriptions, so that we can begin to build a bank of these to share. Similarly, if you notice any category of resources missing, please let us know and we can then add it</li>
        <li>If you are keen to get involved as an active member of the RefugEAP Network Working Group (e.g. working to help us build content for the website) or perhaps a volunteer tutor on the RefugEAP Programme, you can fill in this <a href="https://docs.google.com/forms/d/e/1FAIpQLSfOXfBQWSieyV7L_Cb2QJMy7OgFJeArwVklp0lWpwGE9vc5TA/viewform" style="text-decoration: underline;">online expression of interest form</a></li>
        <li>Contribute a post to our website via the <a href="https://refugeap.org/blog/" style="text-decoration: underline;">Blog</a>. This might be in the form of a case study, a testimonial, or another type of contribution</li>
        <li>For any other queries, please contact the RefugEAP Network Working Group at <a href="mailto:refugeap-network@baleap.org" style="text-decoration: underline;">refugeap-network@baleap.org</a></li>
        <li>You can also follow <a href="https://twitter.com/RefugEAP" style="text-decoration: underline;">@RefugEAP</a> on Twitter, and follow RefugEAP Programme project updates on <a href="https://www.researchgate.net/project/RefugEAP-Programme-Using-EAP-to-facilitate-access-to-Higher-Education-for-refugee-background-students-via-English-language-pathways" style="text-decoration: underline;">Research Gate</a></li>
    </ul>
</section>
